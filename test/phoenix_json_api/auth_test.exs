defmodule PhoenixJsonApi.AuthTest do
  use PhoenixJsonApi.DataCase
  ...
  describe "users" do
    ...
    test "list_users/0 returns all users" do
      user = user_fixture()
      assert Enum.any?(Auth.list_users(), fn au -> user.email == au.email end)
    end

    test "get_user!/1 returns the user with given id" do
      user = user_fixture()
      user_response =  Auth.get_user!(user.id)
